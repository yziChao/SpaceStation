$(document).ready(function() {
  ...
  $('#id_username').attr('placeholder', 'Ej: SpaceStation');
  $('#id_first_name').attr('placeholder', 'Ej: Space');
  $('#id_last_name').attr('placeholder', 'Ej: Station');
  $('#id_email').attr('placeholder', 'Ej: spacestation@ss.com');
